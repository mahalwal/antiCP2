...
X_c5, Y_c5, X_c10, Y_c10, X_c15, Y_c15, Xval_c5, Yval_c5, Xval_c10, Yval_c10, Xval_c15, Yval_c15 = preprocessing(rand='rand_')


X_n5, Y_n5, X_n10, Y_n10, X_n15, Y_n15, Xval_n5, Yval_n5, Xval_n10, Yval_n10, Xval_n15, Yval_n15 = preprocessing(xt='n', rand='rand_')





hyper_parameter_tuning(X_c5, Y_c5, "rand_c5.csv")
hyper_parameter_tuning(X_c10, Y_c10, "rand_c10.csv")
hyper_parameter_tuning(X_c15, Y_c15, "rand_c15.csv")


hyper_parameter_tuning(X_n5, Y_n5, "rand_n5.csv")
hyper_parameter_tuning(X_n10, Y_n10, "rand_n10.csv")
hyper_parameter_tuning(X_n15, Y_n15, "rand_n15.csv")





clf1 = SVC(C=10, gamma=0.5, kernel='rbf', probability=True)
clf2 = SVC(C=4, gamma=0.5, kernel='rbf', probability=True)
clf3 = SVC(C=3, gamma=0.5, kernel='rbf', probability=True)
clf4 = SVC(C=1, gamma=0.5, kernel='rbf', probability=True)
clf5 = SVC(C=4, gamma=0.5, kernel='rbf', probability=True)
clf6 = SVC(C=3, gamma=0.5, kernel='rbf', probability=True)
...
neg_train_c5, neg_train_c10, neg_train_c15, neg_valid_c5, neg_valid_c10, neg_valid_c15, pos_train_c5, pos_train_c10, pos_train_c15, pos_valid_c5, pos_valid_c10, pos_valid_c15 = preprocessing2(rand='rand_')


neg_train_n5, neg_train_n10, neg_train_n15, neg_valid_n5, neg_valid_n10, neg_valid_n15, pos_train_n5, pos_train_n10, pos_train_n15, pos_valid_n5, pos_valid_n10, pos_valid_n15 = preprocessing2(xt='n', rand='rand_')
...
hyper_parameter_tuning(X_c5, Y_c5, "rand_nc5.csv")
hyper_parameter_tuning(X_c10, Y_c10, "rand_nc10.csv")
hyper_parameter_tuning(X_c15, Y_c15, "rand_nc15.csv")


clf1 = SVC(C=4, gamma=0.5, kernel='rbf', probability=True)
clf2 = SVC(C=3, gamma=0.5, kernel='rbf', probability=True)
